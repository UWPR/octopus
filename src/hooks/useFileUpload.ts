...
/**
 * PapaParse auto-generates field names like "_1", "_2", "__parsed_extra" for
 * columns with empty/blank headers (e.g. trailing commas in CSV). This helper
 * identifies those so we can exclude them from the UI.
 */
